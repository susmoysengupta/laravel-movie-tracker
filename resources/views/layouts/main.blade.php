...
<body class="font-sans bg-gray-900 text-white">
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                    <div class="relative md:ml-4 mt-3 md:mt-0">
                        <input type="text" class="bg-gray-800 rounded-full w-64 px-4 pl-8 py1 focus:outline-none focus:shadow-outline" placeholder="Search">
    ...
    <footer class="border border-t border-gray-800">
        <div class="container mx-auto text-sm px-4 py-6">
            <p>Powered by <a href="https://www.themoviedb.org/documentation/api" class="underline hover:text-gray-300">TMDB API</a></p>
            <p>Inspired by Andre Madarang</p>
        </div>
    </footer>
</body>
</html>