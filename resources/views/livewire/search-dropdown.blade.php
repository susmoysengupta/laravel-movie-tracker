<div class="relative md:ml-4 mt-3 md:mt-0">
    <input wire:model.debounce.586ms="search" type="text" class="bg-gray-800 rounded-full w-64 px-4 pl-8 py1 focus:outline-none focus:shadow-outline" placeholder="Search">
